...
<body>
	...
	<style type="text/css">
		body{
			background-image:url('./assets/img/private-parties-slider.jpg');
		}
	...
	<div id="box">
		...
		<form method="post">
			<div style="font-size: 40px;margin: 10px;color: white; padding-left:130px; padding-bottom:20px;">Login</div>
